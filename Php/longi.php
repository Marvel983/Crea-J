...
<head>
    <meta charset="UTF-8">
    <title>Sesiónes 1</title>
    <link rel="stylesheet" href="../Style-es/style-sesion.css">
...
<body>
    ...
    <section class="form-sesion">
        ...
        <a class="links" href="../Html-es/Principal.html"><input class="botones" type="submit" name="iniciar" value="Iniciar"></a>
        <a class="links" href="../Html-es/Sesion-2.html"><input class="botones" type="submit" name="" value="Registrarse"></a>
        <a class="links" href="../Html-es/Principal.html"><input class="botones" type="submit" name="" value="Volver"></a>
    ...
    <script src="../Scrip-es/validacion_usuario.js"></script>
